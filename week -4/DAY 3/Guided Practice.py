from pathlib import Path           #استورد path عشان اتعامل مع مسارات المجلدات والملفات
...
students = [
    {"name": "طيف", "score": 99},            #سويت Dictionary للطلاب
...
except json.JSONDecodeError:                              #في حالة الملف غير صالح
    print("invaild json file")


else:                                      #يشتغل فقط اذا تمت العملية بدون أخطاء
    print("Students loaded successfully")
finally:                                                        #يشتغل دايم سواء تمت العملية أم لا
